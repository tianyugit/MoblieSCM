...
public class Mobstock {
	...
	public String toString() {
		return "Mobstock [sn1=" + sn1 + ", sn2=" + sn2 + ", mobtypeid="
				+ mobtypeid + ", color=" + color + ", config=" + config
				+ ", fristsupplierid=" + fristsupplierid + ", firstintime="
				+ firstintime + ", lastsupplierid=" + lastsupplierid
				+ ", lastintime=" + lastintime + ", buyprice=" + buyprice
				+ ", cost=" + cost + ", lossamount=" + lossamount + ", orgid="
				+ orgid + ", status=" + status + "]";
	}
