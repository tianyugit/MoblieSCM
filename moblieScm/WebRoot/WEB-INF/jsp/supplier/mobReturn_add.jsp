...
<html>
  <head>
	...
	<body>
		...
		<form action="mobReturn_add.do" method="post" name="myform"  onsubmit="getData()">
			<table class="inputTable" width="90%" align="center" style="margin-top:10px">
				...
				<tr>
					<th>供应商类别</th>
					<td>
						<select name="supTypeId" class="text" style="width:100" onchange="find(this)">
					...
					<th>供应商</th>
					<td>
						<select name="mobreturn.supplierid" class="text" style="width:100" id="supplierID">
					...
					<th>品牌名称</th>
					<td>
						<select name="brand" class="text" style="width:100" onchange="brandreq(this)">
					...
					<th>机型</th>
					<td>
						<select name="mobreturn.mobtypeid" class="text"  style="width:100" id="mobTypeID">
							<option>选择机型</option>
			...
			<table align="center" width="90%" class="inputTable" style="border-top:none">
				<tr>
					...
					<th width="220">
						<input type="text"  name="sn1" value="" class="easyui-validatebox text" maxlength="15" />
					</th>
			...
			<div align="center">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="button" name="but2" value="返回" class="btn cancel" onclick="location='mobReturn_list.do'"/>
			</div>
		</form>
