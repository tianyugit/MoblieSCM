...
<html>
  ...
  <body>
    ...
    <form action="payee_add.do" method="post" >
      <table width="500" align="center" style="margin-top:30px" class="inputTable">    
        ...
        <tr>
          <th>金额：</th>
          <td><input class="text" name="custPayee.incomemoney" /></td>
        </tr>    
        <!-- <tr>
            <th>是否计算现金返利</th>
            <td>
        ...
        <tr>
          <th>备注：</th>
          <td><textarea class="text" name="custPayee.remark" style="width:300px;height:46px"/></textarea></td>
        </tr>       
      </table>
      <table border="0" width="500" align="center" style="margin-top:20px">
        <tr><td align="center">
          <input type="submit" class="btn ok" value="确定" />
          <input type="button" class="btn cancel" value="取消" onclick="location='payee_list.do'"/>
        </td></tr>
      </table>
    </form>    
  </body>
