    ...
    <form action="color_addColor.do" method="post">
      <table border="0" width="500" align="center" style="margin-top:10px">
        <tr>
          ...
          <td width="180" align="left"><input name="color.color" class="text"/></td>
    ...
    <table class="table" rowNum="15" width="500" align="center" >
      ...
      <c:forEach items="${colorList}" var="color">
        <tr>
          <td>${color.color}</td>
          <td>
              <c:url value="color_delColor.do" var="delUrl">
                <c:param name="color.color" value="${color.color}"></c:param>
              </c:url>
