...
<html>
  ...
  <body>
    ...
    <form action="mobType_addType.do" method="post" name="myform" onsubmit="getData();">
      <table width="500" align="center" style="margin-top:30px" class="inputTable">       
        <tr>
          <th>型号编号：</th>
          <td><input class="text" name="mobType.mobtypeid" value="${mobType.mobtypeid}" maxlength=10  /></td>
        </tr>    
        <tr>
          <th>品牌：</th>
          <td>
